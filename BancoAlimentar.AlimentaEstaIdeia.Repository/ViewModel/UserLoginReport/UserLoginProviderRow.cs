// -----------------------------------------------------------------------
// <copyright file="UserLoginProviderRow.cs" company="Federação Portuguesa dos Bancos Alimentares Contra a Fome">
...
{
    /// <summary>
    /// Login and registration counts for a single provider.
    /// </summary>
    public class UserLoginProviderRow
    {
        /// <summary>

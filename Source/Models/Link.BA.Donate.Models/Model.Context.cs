...
namespace Link.BA.Donate.Models
{
    ...
    public partial class BancoAlimentarEntities : DbContext
    {
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(DonationEntity).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(LastPayedDonationEntity).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(ProductCatalogueEntity).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(DonorsPictureEntity).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(TotalDonationsEntity).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(DonationItemsEntity).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(DonationByReferenceEntity).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(SumTotalPayedDonationEntity).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(RemaxContactEntity).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(AllDonorsEntity).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(TotalDonationValueEntity).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(QuantitiesByProductEntity).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(FoodBankEntity).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(GetLastAepsFile_Result).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(GetNotPaidDonations_Result).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(QuantitiesByFoodBankAndProductEntity).Assembly);

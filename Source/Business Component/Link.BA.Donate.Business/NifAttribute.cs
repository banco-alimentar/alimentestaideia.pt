...
{
    public class NifAttribute : ValidationAttribute//, IClientValidatable
    {
        ...
        public static bool ValidateNif(string nif)
        {
            ...
            if (Int32.TryParse(nif, out result) && nif.Length == 9)
            {
        ...
        {
            var mcvr = new ModelClientValidationRule()
            {
                ErrorMessage = FormatErrorMessage(metadata.GetDisplayName()),
                ValidationType = "validnif"
            };

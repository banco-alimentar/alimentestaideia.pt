...
namespace Easypay.Rest.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/0.0.0/csharp");
        ...
        public Configuration(
            ...
            string basePath = "https://api.prod.easypay.pt/2.0") : this()
        {
        ...
        {
            string report = "C# SDK (Easypay.Rest.Client) Debug Report:\n";

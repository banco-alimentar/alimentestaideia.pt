...
namespace Easypay.Rest.Client.Model
{
    ...
    public partial class NotificationAuthorisation : IValidatableObject
    {
        /// <summary>
        ...
        public NotificationAuthorisation(PropertiesHasID account = default(PropertiesHasID), PropertiesHasID authorisation = default(PropertiesHasID))
        {

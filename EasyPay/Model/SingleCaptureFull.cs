...
namespace Easypay.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SingleCaptureFull")]
    public partial class SingleCaptureFull : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleCaptureFull" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SingleCaptureFull() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleCaptureFull" /> class.
        /// </summary>
        ...
        public SingleCaptureFull(string id = default(string), CaptureStatus status = default(CaptureStatus), string descriptive = default(string), string transactionKey = default(string), DateOnly captureDate = default(DateOnly), CaptureAccount account = default(CaptureAccount), Collection<CaptureSplit> splits = default(Collection<CaptureSplit>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for SingleCaptureFull and cannot be null");
            }
            this.Id = id;
            this.Status = status;
            ...
            if (descriptive == null)
            {
                throw new ArgumentNullException("descriptive is a required property for SingleCaptureFull and cannot be null");
            }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SingleCaptureFull {\n");

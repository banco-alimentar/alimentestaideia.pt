...
{
    /// <summary>
    /// InlineObject5Customer
    /// </summary>
    [DataContract(Name = "inline_object_5_customer")]
    public partial class InlineObject5Customer : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject5Customer" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineObject5Customer() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject5Customer" /> class.
        /// </summary>
        ...
        public InlineObject5Customer(string id = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for InlineObject5Customer and cannot be null");
            }
            this.Id = id;
        }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineObject5Customer {\n");

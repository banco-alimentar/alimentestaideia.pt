...
{
    /// <summary>
    /// SubscriptionIdPatchRequestCustomer
    /// </summary>
    [DataContract(Name = "_subscription__id__patch_request_customer")]
    public partial class SubscriptionIdPatchRequestCustomer : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionIdPatchRequestCustomer" /> class.
        /// </summary>
        ...
        public SubscriptionIdPatchRequestCustomer(Guid id = default(Guid), string name = default(string), string email = default(string), string phone = default(string), string phoneIndicative = default(string), string fiscalNumber = default(string), string key = default(string), string language = default(string))
        {
            this.Id = id;
            this.Name = name;
            this.Email = email;
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubscriptionIdPatchRequestCustomer {\n");

...
{
    /// <summary>
    /// OutPaymentIdGet200Response
    /// </summary>
    [DataContract(Name = "_out_payment__id__get_200_response")]
    public partial class OutPaymentIdGet200Response : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OutPaymentIdGet200Response" /> class.
        /// </summary>
        ...
        public OutPaymentIdGet200Response(Guid id = default(Guid), StatusEnum? status = default(StatusEnum?), string type = @"transfer", string method = default(string), string descriptive = default(string), SubscriptionPost201ResponseCustomer customer = default(SubscriptionPost201ResponseCustomer), SubscriptionPost201ResponseCustomer account = default(SubscriptionPost201ResponseCustomer), SubscriptionPost201ResponseCustomer outAccount = default(SubscriptionPost201ResponseCustomer), string key = default(string), double value = default(double), string scheduleAt = default(string), Collection<AuthorisationIdGet200ResponseTransactionsInner> transactions = default(Collection<AuthorisationIdGet200ResponseTransactionsInner>), string createdAt = default(string))
        {
            this.Id = id;
            this.Status = status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OutPaymentIdGet200Response {\n");

...
{
    /// <summary>
    /// CaptureIdPostRequestSplitsInner
    /// </summary>
    [DataContract(Name = "_capture__id__post_request_splits_inner")]
    public partial class CaptureIdPostRequestSplitsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaptureIdPostRequestSplitsInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CaptureIdPostRequestSplitsInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CaptureIdPostRequestSplitsInner" /> class.
        /// </summary>
        ...
        public CaptureIdPostRequestSplitsInner(string splitKey = default(string), string splitDescriptive = default(string), double value = default(double), CaptureIdPostRequestSplitsInnerAccount account = default(CaptureIdPostRequestSplitsInnerAccount), double marginValue = default(double), CaptureIdPostRequestSplitsInnerMarginAccount marginAccount = default(CaptureIdPostRequestSplitsInnerMarginAccount))
        {
            this.Value = value;
        ...
        */
        ...
        public CaptureIdPostRequestSplitsInnerMarginAccount MarginAccount { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaptureIdPostRequestSplitsInner {\n");
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.MarginValue < (double)0.01)
            {
                yield return new ValidationResult("Invalid value for MarginValue, must be a value greater than or equal to 0.01.", new[] { "MarginValue" });
            }

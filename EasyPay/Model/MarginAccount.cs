...
{
    /// <summary>
    /// The account to which the margin value should be routed. This field specifies the destination account for the margin portion of the funds, ensuring that the correct recipient receives the designated margin value.
    /// </summary>
    [DataContract(Name = "MarginAccount")]
    public partial class MarginAccount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MarginAccount" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MarginAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MarginAccount" /> class.
        /// </summary>
        ...
        public MarginAccount(string id = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for MarginAccount and cannot be null");
            }
            this.Id = id;
        }

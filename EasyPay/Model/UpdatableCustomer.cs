...
namespace Easypay.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdatableCustomer")]
    public partial class UpdatableCustomer : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatableCustomer" /> class.
        /// </summary>
        ...
        public UpdatableCustomer(string name = default(string), string email = default(string), string phone = default(string), string phoneIndicative = @"351", string fiscalNumber = default(string), string key = default(string), string language = @"PT")
        {
            this.Name = name;
            this.Email = email;
            this.Phone = phone;
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdatableCustomer {\n");

...
{
    /// <summary>
    /// PaymentFrequentMethodResponseMethodSddMandate
    /// </summary>
    [DataContract(Name = "Payment_Frequent_Method_Response_method_sdd_mandate")]
    public partial class PaymentFrequentMethodResponseMethodSddMandate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentFrequentMethodResponseMethodSddMandate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentFrequentMethodResponseMethodSddMandate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentFrequentMethodResponseMethodSddMandate" /> class.
        /// </summary>
        ...
        public PaymentFrequentMethodResponseMethodSddMandate(string id = default(string), string iban = default(string), string key = default(string), string name = default(string), string email = default(string), string phone = default(string), string accountHolder = default(string), string countryCode = default(string), string maxNumDebits = default(string), string billingEntity = @"PT16103627", string referenceAdc = default(string))
        {
            // to ensure "iban" is required (not null)
            if (iban == null)
            {
                throw new ArgumentNullException("iban is a required property for PaymentFrequentMethodResponseMethodSddMandate and cannot be null");
            }
            this.Iban = iban;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PaymentFrequentMethodResponseMethodSddMandate and cannot be null");
            }
            this.Name = name;
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for PaymentFrequentMethodResponseMethodSddMandate and cannot be null");
            }
            this.Email = email;
            // to ensure "phone" is required (not null)
            if (phone == null)
            {
                throw new ArgumentNullException("phone is a required property for PaymentFrequentMethodResponseMethodSddMandate and cannot be null");
            }
            this.Phone = phone;
            // to ensure "accountHolder" is required (not null)
            if (accountHolder == null)
            {
                throw new ArgumentNullException("accountHolder is a required property for PaymentFrequentMethodResponseMethodSddMandate and cannot be null");
            }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentFrequentMethodResponseMethodSddMandate {\n");

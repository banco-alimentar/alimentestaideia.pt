...
namespace Easypay.Rest.Client.Model
{
    ...
    public partial class PaymentFrequentWithTransactions : IValidatableObject
    {
        ...
        protected PaymentFrequentWithTransactions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentFrequentWithTransactions" /> class.
        /// </summary>
        ...
        public PaymentFrequentWithTransactions(Guid id = default(Guid), string createdAt = default(string), string descriptive = default(string), double value = default(double), string expirationTime = default(string), Currency? currency = default(Currency?), Customer customer = default(Customer), string key = default(string), double maxValue = default(double), double minValue = default(double), bool unlimitedPayments = true, PaymentFrequentMethodResponseMethod method = default(PaymentFrequentMethodResponseMethod))
        {
            this.Value = value;
            this.Id = id;

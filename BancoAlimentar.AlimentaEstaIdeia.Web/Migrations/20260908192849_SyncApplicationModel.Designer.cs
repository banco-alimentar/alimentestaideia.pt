...
namespace BancoAlimentar.AlimentaEstaIdeia.Web.Migrations
{
    ...
    [Migration("20260908192849_SyncApplicationModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BancoAlimentar.AlimentaEstaIdeia.Model.Configuration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BancoAlimentar.AlimentaEstaIdeia.Model.Donation", b =>
                {
                    ...
                    b.Property<bool>("PeriodoOficial")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("ConfirmedPaymentId")
                        .IsUnique()
                        .HasFilter("[ConfirmedPaymentId] IS NOT NULL");
            ...
            modelBuilder.Entity("BancoAlimentar.AlimentaEstaIdeia.Model.EmailCommunication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BancoAlimentar.AlimentaEstaIdeia.Model.Identity.UserLoginEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CampaignId", "LoginProvider");
            ...
            modelBuilder.Entity("BancoAlimentar.AlimentaEstaIdeia.Model.Identity.WebUser", b =>
                {
                    ...
                    b.Property<int?>("RegistrationCampaignId")
                        .HasColumnType("int");

                    b.Property<string>("RegistrationLoginProvider")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("BancoAlimentar.AlimentaEstaIdeia.Model.PaymentNotifications", b =>
                {
                    ...
                    b.HasIndex("PaymentId", "NotificationType")
                        .IsUnique()
            ...
            modelBuilder.Entity("BancoAlimentar.AlimentaEstaIdeia.Model.BasePayment", b =>
                {
                    b.HasOne("BancoAlimentar.AlimentaEstaIdeia.Model.Donation", null)
            ...
            modelBuilder.Entity("BancoAlimentar.AlimentaEstaIdeia.Model.Donation", b =>
                {
                    ...
                    b.HasOne("BancoAlimentar.AlimentaEstaIdeia.Model.BasePayment", "ConfirmedPayment")
                        .WithOne("Donation")
                        .HasForeignKey("BancoAlimentar.AlimentaEstaIdeia.Model.Donation", "ConfirmedPaymentId");

// -----------------------------------------------------------------------
// <copyright file="Angola.cshtml.cs" company="Federação Portuguesa dos Bancos Alimentares Contra a Fome">
...
namespace BancoAlimentar.AlimentaEstaIdeia.Web.Pages
{
    ...
    /// Index page model.
    /// </summary>
    public class AngolaModel : PageModel
    {
        private readonly IUnitOfWork context;
        private readonly SignInManager<WebUser> signInManager;

        /// <summary>
        /// Initializes a new instance of the <see cref="AngolaModel"/> class.
        /// </summary>
        ...
        public void OnGet()
        {
            this.HttpContext.Session.SetInt32("FoodBankIdContext", 24);
        ...
        private void LoadData()
        {
            ...
            TotalDonations = this.context.Donation.GetTotalDonationsOfFoodBank(this.ProductCatalogue, 24);
